...
<?php
    if(isset($_POST['valider'])){
      ...
      sendmail($message,$expediteur);

      $nom = mysqli_real_escape_string($connect,$nom);
      $expediteur = mysqli_real_escape_string($connect,$expediteur);
      ...
      $req .="VALUES ('{$nom}','{$expediteur}','{$commande}','{$message}') ";
        ...
        <form action="" method="post" name="F">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="objet" name="heure">
              ...
              <option value="12h00 à 12h15">12h00 à 12h15</option>
              <option value="12h15 à 12h30">12h15 à 12h30</option>
              <option value="12h30 à 12h45">12h30 à 12h45</option>
              <option value="12h45 à 13h00">12h45 à 13h00</option>
            </select>
          </div>
          <div class="mb-3">
